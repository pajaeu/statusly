            ...
            <div class="flex flex-col h-full justify-between">
                <div class="px-3 py-4">
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a href="{{ route('projects.index') }}" wire:navigate class="text-slate-600 hover:bg-slate-200 flex items-center gap-x-3 rounded-md py-1.5 px-3 text-sm font-medium cursor-pointer transition-colors">
