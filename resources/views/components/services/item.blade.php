...
<div>
    <div class="block w-full p-4 border border-slate-200 rounded-md shadow bg-white hover:border-slate-300 hover:shadow-lg cursor-pointer transition-colors transition-shadow mb-4" wire:key="{{ $service->id }}">
