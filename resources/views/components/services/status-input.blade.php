...
<div {{ $attributes->merge(['class' => 'status-inputs']) }}>
    ...
    <div class="flex items-center gap-3">
        <div class="flex-1">
            <input type="radio" id="operational" wire:model="form.status" value="operational" class="hidden peer" required />
        ...
        <div class="flex-1">
            <input type="radio" id="maintenance" wire:model="form.status" value="maintenance" class="hidden peer" required />
        ...
        <div class="flex-1">
            <input type="radio" id="down" wire:model="form.status" value="down" class="hidden peer" required />
