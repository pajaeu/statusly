        ...
        <div class="bg-white rounded-lg shadow px-6 py-4 mb-6">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="password" name="password" class="w-full p-2 border rounded-lg transition-all focus:ring-2 focus:ring-orange-500 outline-0">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" class="w-full p-2 border rounded-lg transition-all focus:ring-2 focus:ring-orange-500 outline-0">
                    <x-input-error :message="$errors->first('password_confirmation')"/>
                </div>
                <x-button class="w-full !text-sm">Register</x-button>
            </form>
        </div>
        <div class="text-center text-sm text-slate-50">
            <p>Already have an account? <a class="underline hover:no-underline" href="{{ route('login') }}">Login here.</a></p>
        </div>
    </div>
</x-guest-layout>