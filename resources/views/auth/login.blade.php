        ...
        <div class="bg-white rounded-lg shadow px-6 py-4 mb-6">
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="text-center">
                    ...
                    <a class="mt-4 inline-block text-sm text-slate-800 underline hover:no-underline" href="{{ route('password.request') }}">Forgot your password?</a>
                </div>
            </form>
        </div>
        <div class="text-center text-sm text-slate-50">
            <p>Do not have account yet? <a class="underline hover:no-underline" href="{{ route('register') }}">Register now!</a></p>
        </div>
    </div>
</x-guest-layout>